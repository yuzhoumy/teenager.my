...
export const messages = {
  en: {
    ...
    "search.overline": "Metadata search",
    "search.title": "Study materials",
    "search.description":
      "Filter by grade, subject, tags, and origin with shareable URLs. If no subject is selected, results stay grouped by subject so students can scan the library naturally.",
    "search.filtersOverline": "Filters",
    "search.findMaterials": "Find materials",
    ...
    "search.sortedByYear": "Sorted by year, newest first.",
    "search.loadingFacets": "Loading filters and material facets...",
    "search.loadingMaterials": "Loading materials...",
    "search.materialCount": "{count} materials found",
    "search.showingAllMaterials": "Showing all materials.",
    "search.errorTitle": "Search error",
    "search.fetchingMaterials": "Fetching matching materials",
    "search.fetchingMaterialsDescription": "The faceted search is applying your filters now.",
    "search.emptyTitle": "No materials found",
    "search.emptyDescription": "Try removing one or two filters, or switch to a broader grade.",
    "search.subject": "Subject",
    "search.setupNeeded": "Search setup needed",
    "search.setupNeededDescription":
      "This usually means the new `materials` schema and seed data have not been applied to your Supabase project yet.",
    "search.downloadCount": "{count} downloads",
    ...
    "search.submitPlaceholder": "Submit placeholder",
    "search.tag.exercise": "Exercise",
    "search.tag.notes": "Notes",
    "search.tag.pastYear": "Past Year",
    "search.tag.trialPaper": "Trial Paper",
  ...
  ms: {
    ...
    "search.overline": "Carian metadata",
    "search.title": "Bahan pembelajaran",
    "search.description":
      "Tapis mengikut tingkatan, subjek, tag, dan asal dengan URL yang boleh dikongsi. Jika tiada subjek dipilih, keputusan akan kekal dikelompokkan mengikut subjek supaya pelajar lebih mudah menyemak.",
    "search.filtersOverline": "Penapis",
    "search.findMaterials": "Cari bahan",
    "search.clearAll": "Kosongkan semua",
    "search.showFilters": "Tunjuk penapis",
    "search.hideFilters": "Sembunyi penapis",
    "search.grade": "Tingkatan",
    "search.allGrades": "Semua tingkatan",
    "search.subjects": "Subjek",
    "search.tags": "Tag",
    "search.origin": "Asal",
    "search.results": "Keputusan",
    "search.sortedByYear": "Disusun mengikut tahun, terbaru dahulu.",
    "search.loadingFacets": "Sedang memuatkan penapis dan metadata...",
    "search.loadingMaterials": "Sedang memuatkan bahan...",
    "search.materialCount": "{count} bahan ditemui",
    "search.showingAllMaterials": "Memaparkan semua bahan.",
    "search.errorTitle": "Ralat carian",
    "search.fetchingMaterials": "Sedang mendapatkan bahan yang sepadan",
    "search.fetchingMaterialsDescription": "Carian berfaset sedang menggunakan penapis anda sekarang.",
    "search.emptyTitle": "Tiada bahan ditemui",
    "search.emptyDescription": "Cuba buang satu atau dua penapis, atau tukar kepada tingkatan yang lebih umum.",
    "search.subject": "Subjek",
    "search.setupNeeded": "Persediaan carian diperlukan",
    "search.setupNeededDescription":
      "Ini biasanya bermaksud skema dan data seed `materials` yang baharu belum digunakan pada projek Supabase anda.",
    "search.downloadCount": "{count} muat turun",
    "search.openFile": "Buka fail",
    "search.save": "Simpan",
    "search.saved": "Disimpan",
    "search.saving": "Menyimpan...",
    "search.uploadMaterial": "Muat naik bahan",
    "search.placeholder": "Placeholder",
    "search.uploadStudyMaterial": "Muat naik bahan pembelajaran",
    "search.tagsCommaSeparated": "Tag (dipisahkan dengan koma)",
    "search.submitPlaceholder": "Hantar placeholder",
    "search.tag.exercise": "Latihan",
    "search.tag.notes": "Nota",
    "search.tag.pastYear": "Tahun Lepas",
    "search.tag.trialPaper": "Kertas Percubaan",
  ...
  "zh-Hans": {
    ...
    "search.overline": "元数据搜索",
    "search.title": "学习资料",
    "search.description":
      "可按年级、科目、标签和来源筛选，并通过 URL 分享当前视图。若未选择特定科目，结果会按科目分组，方便学生浏览。",
    "search.filtersOverline": "筛选",
    "search.findMaterials": "查找资料",
    "search.clearAll": "清除全部",
    "search.showFilters": "显示筛选",
    "search.hideFilters": "隐藏筛选",
    "search.grade": "年级",
    "search.allGrades": "所有年级",
    "search.subjects": "科目",
    "search.tags": "标签",
    "search.origin": "来源",
    "search.results": "结果",
    "search.sortedByYear": "默认按年份排序，最新在前。",
    "search.loadingFacets": "正在加载筛选与元数据...",
    "search.loadingMaterials": "正在加载资料...",
    "search.materialCount": "找到 {count} 份资料",
    "search.showingAllMaterials": "显示全部资料。",
    "search.errorTitle": "搜索错误",
    "search.fetchingMaterials": "正在获取匹配资料",
    "search.fetchingMaterialsDescription": "分面搜索正在应用你的筛选条件。",
    "search.emptyTitle": "没有找到资料",
    "search.emptyDescription": "尝试减少一两个筛选条件，或切换到更宽泛的年级。",
    "search.subject": "科目",
    "search.setupNeeded": "需要完成搜索设置",
    "search.setupNeededDescription":
      "这通常表示新的 `materials` 数据表结构和 seed 数据尚未应用到你的 Supabase 项目中。",
    "search.downloadCount": "{count} 次下载",
    "search.openFile": "打开文件",
    "search.save": "保存",
    "search.saved": "已保存",
    "search.saving": "保存中...",
    "search.uploadMaterial": "上传资料",
    "search.placeholder": "占位",
    "search.uploadStudyMaterial": "上传学习资料",
    "search.tagsCommaSeparated": "标签（用逗号分隔）",
    "search.submitPlaceholder": "提交占位表单",
    "search.tag.exercise": "练习",
    "search.tag.notes": "笔记",
    "search.tag.pastYear": "历年题",
    "search.tag.trialPaper": "模拟试卷",
