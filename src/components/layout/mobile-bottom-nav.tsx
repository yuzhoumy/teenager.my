...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-[1000] border-t border-border bg-background/95 px-3 pb-[calc(0.5rem+env(safe-area-inset-bottom))] pt-2 backdrop-blur lg:hidden">
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className="block w-full text-center text-[0.68rem] leading-tight">
                  {item.label}
                </span>
              </Link>
            );
